...
# Reading the xl file
xl_param <- read_excel(xl_path, sheet = "Ini")
...
gen_ini_xml(param_table = xl_param, out_path = out_dir)

# using an existing input xml file
in_file <- "/path/to/file_ini.xml"

gen_ini_xml(ini_in_file = in_file ,param_table = xl_param, out_path = out_dir)
