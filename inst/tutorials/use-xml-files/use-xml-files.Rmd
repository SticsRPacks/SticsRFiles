...
if (length(grep("JavaStics.exe",list.files(javastics))) == 0) {
  zip_path <- file.path(work_dir,"JavaSTICS-1.41-stics-9.1.zip")
  system(paste("curl -u stics_user:w10lptr6405 https://w3.avignon.inra.fr/forge/attachments/download/2019/JavaSTICS-1.41-stics-9.1.zip --output", zip_path))
