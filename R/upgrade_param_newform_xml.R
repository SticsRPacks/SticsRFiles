...
upgrade_param_newform_xml <- function(file,
  ...
  # nodes to remove
  form_names <- c("Specificities of cut crops",
  ...
  opt_names <- c("New mineralization of soil organic matter ",
  ...
  prev_sibling <- getNodeS(docObj = old_doc,
                           path = "//formalisme[@nom='residue incorporation']")[[1]]
  ...
  prev_sibling <- getNodeS(docObj = old_doc,
                           path = "//formalisme[@nom='Mineralization models']")[[1]]
  ...
  <choix code="2" nom="no"/>
    ...
    codemineral_node <- getNodeS(docObj = old_doc,
  ...
  prev_sibling <- getNodeS(docObj = old_doc,
                           path = "//formalisme[@nom='evaluation options']")[[1]]
  addSibling(prev_sibling, xmlClone(new_node))
  # ---------------------------------------------------------------------------
