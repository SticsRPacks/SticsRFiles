test_that("Get version number as svlist object", {
  expect_true(inherits(get_version_num("10"), "svlist"))
  expect_true(inherits(get_version_num("V10"), "svlist"))
  expect_true(inherits(get_version_num("v10"), "svlist"))
  expect_true(inherits(get_version_num(10), "svlist"))
...
test_that("Get version number as character object", {
  ...
  expect_equal(ver, get_version_num("10.0", numeric = FALSE))
  expect_equal(ver, get_version_num("v10.0", numeric = FALSE))
  expect_equal(ver, get_version_num("V10.0", numeric = FALSE))
  expect_equal(ver, get_version_num("10.0.0", numeric = FALSE))
  expect_equal(ver, get_version_num(10, numeric = FALSE))
})
