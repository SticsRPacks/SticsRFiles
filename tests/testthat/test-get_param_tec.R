library(SticsRFiles)
# options(warn=-1)
xml_path= file.path(get_examples_path("xml"), "file_tec.xml")
...
test_that("double associated values from single node" , {
  expect_equivalent(unname(unlist(get_param_xml(xml_path,c("julapI_or_sum_upvt","amount")))),
                    c(c(178,185,193,198,200,204,207,211,214,218,221,232,239,249,257,264),
