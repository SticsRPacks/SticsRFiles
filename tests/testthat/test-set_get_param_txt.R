...
tmp1 <- get_param_txt(workspace = path, param = "stlevamf", stics_version = stics_version)
codevar <- get_param_txt(workspace = path, param = "codevar", stics_version = stics_version)[[1]]
tmp2 <- get_param_txt(workspace = path, param = "stlevamf", variety = codevar, stics_version = stics_version)
variete <- as.numeric(get_param_txt(workspace = path, param = "variete", stics_version = stics_version)[[1]])
tmp3 <- get_param_txt(workspace = path, param = "stlevamf", variety = variete, stics_version = stics_version)
...
varieties <- get_param_txt(workspace = path, stics_version = stics_version)$plant$plant1$codevar[1:3]
#tmp1 <- as.numeric(get_param_txt(workspace = path, param = "stlevamf", variety = varieties))
tmp1 <- get_param_txt(workspace = path, param = "stlevamf", variety = varieties, stics_version = stics_version)[[1]]
tmp2 <- get_param_txt(workspace = path, stics_version = stics_version)$plant$plant1$stlevamf[1:3]
...
tmp <- get_param_txt(workspace = path, param = "forme", exact = TRUE, stics_version = stics_version)[[1]]
set_param_txt(
...
tmp2 <- get_param_txt(workspace = path, param = "forme", exact = TRUE, stics_version = stics_version)[[1]]
...
tmp <- get_param_txt(workspace = path, param = "stlevamf", stics_version = stics_version)[[1]]
set_param_txt(
...
tmp2 <- get_param_txt(workspace = path, param = "stlevamf", stics_version = stics_version)[[1]]
...
tmp <- get_param_txt(workspace = path, param = "stlevamf", variety = 4, stics_version = stics_version)[[1]]
set_param_txt(
  workspace = path, param = "stlevamf",
...
tmp2 <- get_param_txt(workspace = path, param = "stlevamf", variety = 4, stics_version = stics_version)[[1]]
...
path <- file.path(get_examples_path("txt", stics_version = stics_version), "intercrop_pea_barley")
# Copy example to test in tempdir since the files will be modified by set_param
file.copy(from = file.path(path, list.files(path)), to = tempdir(), overwrite = TRUE)
path <- tempdir()

# Get and modify the non-varietal parameter "forme" for the simulated variety
tmp <- get_param_txt(workspace = path, param = "forme", exact = TRUE, stics_version = stics_version)
plant <- 2
set_param_txt(
  workspace = path, param = "forme",
...
tmp2 <- get_param_txt(workspace = path, param = "forme", exact = TRUE, stics_version = stics_version)
...
# Get and modify the varietal parameter "stlevamf" for the simulated variety
tmp <- get_param_txt(workspace = path, param = "stlevamf", stics_version = stics_version)
plant <- 2
set_param_txt(
  workspace = path, param = "stlevamf",
  #value = as.numeric(tmp[plant]) + 1, plant_id = 2
  value = as.numeric(tmp[[plant]]) + 1,
  plant_id = 2,
  stics_version = stics_version
)
tmp2 <- get_param_txt(workspace = path, param = "stlevamf", stics_version = stics_version)
