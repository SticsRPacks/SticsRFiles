library(SticsRFiles)
# options(warn=-1)
xml_path= file.path(get_examples_path("xml"), "file_sta.xml")
...
test_that("singles values from multiples nodes",{
  expect_equivalent(unname(unlist(get_param_xml(xml_path,c("codeetp","alphapt","codeclichange","codaltitude",
