...
The package installation can be remotely done directly from [GitHub](https://github.com/), using either `devtools` or the lightweight `remotes` one package (check remotes tools installation notes [here](https://sticsrpacks.github.io/SticsOnR#remote-installation-tools))
