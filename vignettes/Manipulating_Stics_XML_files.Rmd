...
par_xml <- file.path(get_examples_path("xml", stics_version = stics_version), "param_gen.xml")
...
```{r , eval = TRUE, echo = FALSE, class.output="xml"}
sol_xml <- 
  file.path(get_examples_path("xml", stics_version = stics_version), "sols.xml")
...
```{r , eval = TRUE, echo = FALSE, class.output="xml"}
tec_xml <- file.path(get_examples_path("xml", stics_version = stics_version), "file_tec.xml")
