...
# Displaying only some head lines of the data.frame elements
head(param_names$sols.xml, n = 10)

head(param_names$param_gen.xml, n = 10)
...
### Getting a list of parameters names vectors
```{r}
param_names <- get_param_names_xml(xml_file = files_list, output = "list")
