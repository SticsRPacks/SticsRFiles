...
params:
  ...
  xml_loc_dir: !r "/home/plecharpent/tmp/tests_SticsRFiles/xml"
---
...
# Getting XML file copy from the library
...
# For linux 
#> "/path/to/R/user/libraries/x86_64-pc-linux-gnu-library/3.6/SticsRFiles/extdata/xml/examples/V9.0"
...
* Overwriting the existing file: use ```overwrite = TRUE```

* Generating a file in another directory with the same name: use `out_path` for setting an output directory

* Specifying a new file name: use  `out_file` for giving the new file name
