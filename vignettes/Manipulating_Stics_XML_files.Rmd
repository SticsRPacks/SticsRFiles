...
# Setting a new one
set_param_xml(par_gen, param_name = "codeactimulch", values = 2, overwrite = T)
...
# Setting a new one
set_param_xml(par_gen, param_name = "tnitopt", values = 29.5, overwrite = T)
...
# Setting a new one
set_param_xml(sols, param_name = "argi", values = 33, select = "sol",
...
set_param_xml(sols, param_name = "argi", values = list(1:33), overwrite = T)

# Controlling written values
get_param_xml(sols,param_name = "argi")

# Setting the same value for all occurences
set_param_xml(sols, param_name = "argi", values = 40, overwrite = T)
...
set_param_xml(sols, param_name = list("argi", "pH"), values = list(1:33,33:1), overwrite = T)

# Controlling written values
get_param_xml(sols,param_name = c("argi", "pH"))

# Setting the same value for all occurences
set_param_xml(sols, param_name = c("argi", "pH"), values = list(50, 8), overwrite = T)
...
# Setting new values
set_param_xml(sols, param_name = c("argi", "pH"), values = list(50,8), select = "sol",
...
# Setting new values
set_param_xml(sols, param_name = c("epc", "infil"), values = list(18:22,48:52), select = "sol", select_value = "solcanne", overwrite = T )
...
# Setting new values
set_param_xml(tec, param_name = c("julapI_or_sum_upvt", "amount"), values = list(200:215,20:35), overwrite = T )
...
# Setting new values
set_param_xml(sols, param_name = c("epc", "infil"), values = list(20:18,50:48), select = "sol", select_value = "solcanne", overwrite = T, ids = 1:3 )
...
# Setting new values
set_param_xml(tec, param_name = c("julapI_or_sum_upvt", "amount"), values = list(204:200,24:20), overwrite = T, ids = 1:5)
