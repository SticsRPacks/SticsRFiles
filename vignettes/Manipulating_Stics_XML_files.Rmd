...
# Setting new values
set_param_xml(sols, param_name = c("epc", "infil"), values = list(18:22,48:52), select = "sol", value = "solcanne", overwrite = T )
...
# Setting new values
set_param_xml(sols, param_name = c("epc", "infil"), values = list(20:18,50:48), select = "sol", value = "solcanne", overwrite = T, ids = 1:3 )
