...
params:
  version: !r SticsRFiles:::get_stics_versions_compat()$latest_version
---
...
xml_dir <- get_examples_path( file_type = "xml", stics_version = version_name)
...
# Setting a new one
set_param_xml(par_gen, param = "codeactimulch", values = 2, overwrite = T)
...
# Setting a new one
set_param_xml(par_gen, param = "tnitopt", values = 29.5, overwrite = T)
...
set_param_xml(sols, param = "argi", values = list(1:33), overwrite = T)

# Controlling written values
get_param_xml(sols, param = "argi")

# Setting the same value for all occurences
set_param_xml(sols, param = "argi", values = 40, overwrite = T)
...
set_param_xml(sols, param = list("argi", "pH"), values = list(1:33,33:1), overwrite = T)

# Controlling written values
get_param_xml(sols, param = c("argi", "pH"))

# Setting the same value for all occurences
set_param_xml(sols, param = c("argi", "pH"), values = list(50, 8), overwrite = T)
...
set_param_xml(sols, param = c("argi", "pH"), values = list(50,8), select = "sol",
              select_value = "solcanne", overwrite = T )
...
# Setting new values
set_param_xml(sols, param = c("epc", "infil"), values = list(18:22,48:52), select = "sol", select_value = "solcanne", overwrite = T )
...
# Setting new values
set_param_xml(tec, param = c("julapI_or_sum_upvt", "amount"), values = list(200:215,20:35), overwrite = T )
...
# Setting new values
set_param_xml(sols, param = c("epc", "infil"), values = list(20:18,50:48), select = "sol", select_value = "solcanne", overwrite = T, ids = 1:3 )
...
# Setting new values
set_param_xml(tec, param = c("julapI_or_sum_upvt", "amount"), values = list(204:200,24:20), overwrite = T, ids = 1:5)
