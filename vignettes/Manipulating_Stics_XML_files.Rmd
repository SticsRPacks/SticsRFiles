...
params:
  xml_loc_dir: /home/plecharpent/tmp/tests_SticsRFiles/xml
  show_xpath: TRUE
---
...
#print(xml_dir)
options(warn=-1)
xml_loc_dir <- params$xml_loc_dir
show_xpath <- params$show_xpath
```
...
Simple functions reproducible use cases based on 2 essential functions **get_params_xml** and **set_params_xml** are described in this document.
...
```{r set_xml_dir}
xml_dir <- system.file(file.path("extdata","xml","examples","V9.0"), package = "SticsRFiles" )

# For linux 
#> "/path/to/user/R/x86_64-pc-linux-gnu-library/3.6/SticsRFiles/extdata/xml/examples/V9.0"

# For windows
#> "C:/Users/username/Documents/R/win-lib/3.6/SticsRFiles/extdata/xml/examples/V9.0"
...
# head(xml_files, n = 3)
# For linux 
#> [1] "/path/to/user/R/x86_64-pc-linux-gnu-library/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_ini.xml"     
#> [2] "/path/to/user/R/x86_64-pc-linux-gnu-library/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_plt.xml"     
#> [3] "/path/to/user/R/x86_64-pc-linux-gnu-library/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_sta.xml"     

# For windows
#> [1] "C:/Users/username/Documents/R/win-lib/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_ini.xml"   
#> [2] "C:/Users/username/Documents/R/win-lib/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_plt.xml"    
#> [3] "C:/Users/username/Documents/R/win-lib/3.6/SticsRFiles/extdata/xml/examples/V9.0/file_sta.xml"     
...
# Retrieving parameters names from files (function: **get_param_names_xml**)
...
param_names <- get_param_names_xml(files_list)

# Displaying only some head lines of the list elements
...
# Getting parameters values from a file  (function: **get_param_xml**)   
...
# Replacing parameters values in files  (function: **set_param_xml**)
