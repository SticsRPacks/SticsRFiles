...
```{r eval=FALSE}
library(SticsRFiles)
example_data = SticsRFiles::download_data(example_dirs = "study_case_1", "V10.0")
```
...
#> usms_path, : Not any sim file detected in workspace/tmp/RtmpjkDYAq/data-master/
#> study_case_1/V9.0/XmlFiles
```
