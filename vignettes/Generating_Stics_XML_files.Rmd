...
usm_xl_file <-  download_usm_xl(file = "inputs_stics_example.xlsx", dest_dir = workspace_path)
```
...
usm_csv_file <- download_usm_csv(file = "inputs_stics_example_USMs.csv", out_dir = csv_dir )
