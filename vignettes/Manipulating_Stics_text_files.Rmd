...
* `append`: instead of changing the value of a parameter that already exist in the files, a parameter can be added to the file using this argument. This is used mainly by developpers that added a parameter to the model and need to programatically add it to the input files.
