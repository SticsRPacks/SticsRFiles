...
The XML files structure has changed either between STICS version **9.2** and versions **10.X.Y** or between STICS versions **10.X.Y** and version 11.0.0 and a transformation is mandatory for ugrading from a major version to a upper one.    
